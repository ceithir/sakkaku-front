const data = [
  ...
  { label: "Black Tear Peak", x: 6, y: 75 },
  ...
  { label: "Clear Water Village", x: 24, y: 79 },
  ...
  { label: "Plains Wind Monestrey", x: 14, y: 23 },
  ...
  { label: "Slow Tide Harbor", x: 48, y: 37 },
  ...
  { label: "The Defiled Court of Lady Yukiko", x: 11, y: 88 },
